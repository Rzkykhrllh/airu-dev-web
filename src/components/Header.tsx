    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-3">
          ...
          >
            ...
            >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 px-5 py-3 text-sm font-bold mono-label text-muted hover:bg-paper-soft hover:text-secondary transition-colors whitespace-nowrap border-t border-muted"
              >
          ...
          <Link
            href="/#contact"
            className="border-4 border-ink bg-primary text-paper text-sm font-black mono-label px-5 py-2 hover:bg-paper hover:text-ink transition-all retro-shadow"
          >
            CONTACT
          </Link>
        </nav>
        <Link
          href="/#contact"
          className="md:hidden border-4 border-ink bg-primary text-paper px-4 py-2 text-sm font-black mono-label hover:bg-paper hover:text-ink transition-all retro-shadow"
        >
          CONTACT
        </Link>
      </div>
