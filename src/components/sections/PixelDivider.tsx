export default function PixelDivider() {
  return (
    <div className="py-8 bg-night overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-center gap-2">
        ...
        {/* Center text */}
        <div className="border-4 border-paper bg-night px-6 py-2">
          <span className="mono-label text-xs text-paper tracking-widest">LEARN • BUILD • REPEAT</span>
        </div>
